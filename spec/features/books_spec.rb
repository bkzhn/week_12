...
describe "Books" do
  ...
  describe "Add cover book page" do
    let(:user) { FactoryGirl.create(:user) }
    before(:each) do
      visit root_path
      fill_in "username", with: user.username
      ...
      visit cover_path(id: @book.id)
    end

    it "should have Library App | Add book cover title" do
      should have_selector("title", :text => "Library App | Add book cover")
    end
    ...
    it "should have form for book cover" do
      should have_selector("form")
    end

    it "should have file field for book cover" do
      should have_selector("#book_cover")
    end
